...
export class StudentsController {
  ...
  @CheckAbilities({ subject: Student, action: Action.CREATE })
  ...
  @CheckAbilities({ subject: Student, action: Action.UPDATE })
  ...
  @CheckAbilities({ subject: Student, action: Action.DELETE })
